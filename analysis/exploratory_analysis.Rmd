...
ggplot(flights_weather_df, aes(x = humidity, y = wind_speed, color = factor(IS_WEATHER_DELAY))) +
  geom_point() +
...
# pressure: slightly lower for weather delayed flights SHOW
# wind speed, quite similar
# humidity vs wind speed: When high windspeed and high humidity occur together, it can create conditions that are favorable for the formation of severe weather systems SHOW
...
glimpse(flights_weather_df)

ggplot(flights_weather_df, aes(x = rain, y = IS_WEATHER_DELAY, color = rain)) +
...
ggplot(flights_weather_df, aes(x = snow, y = IS_WEATHER_DELAY, color = snow)) +
