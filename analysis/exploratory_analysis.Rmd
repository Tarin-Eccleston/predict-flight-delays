...
snow_label_plot = ggplot(flights_weather_df, aes(x = snow, y = factor(IS_WEATHER_DELAY), color = snow)) +
  geom_jitter(width = 0.2, height = 0.1, size = 3, alpha = 0.5) +
  labs(x = "Types of Snow", y = "", title = "Snow vs Weather Delay") +
  scale_y_discrete(labels = c("Other Flights", "Weather Delayed Flights"))
```
